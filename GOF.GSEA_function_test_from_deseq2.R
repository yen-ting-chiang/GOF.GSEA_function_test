...
setwd("C:/Users/cmuh/Documents/YenTing_document/GOF.GSEA_function_test/run_second_part_2")

GOF.TCGA.do.deseq2.GSEA.DEG <- function(project_name, 
                     hugo_gene_name, 
                     grouping_type, 
                     conpairing_type, 
                     reference_type, 
                     design_formula)
{
  ...
  load(sprintf("%s.%s.ColData.rdata", 
               project_name, 
               hugo_gene_name))
  load(sprintf("%s.%s.RowData.rdata", 
               project_name, 
               hugo_gene_name))
...
GOF.TCGA.do.deseq2.GSEA.DEG(project_name = "CESC", 
         hugo_gene_name = "TP53",
